!function()
		...
		"function"!=typeof Object.create&&(Object.create=function(a)
			...
			var e=
				...
				,startZoom:function()
					{
					var b=this;
					if(b.nzWidth=b.$elem.width(),b.nzHeight=b.$elem.height(),b.isWindowActive=!1,b.isLensActive=!1,b.isTintActive=!1,b.overWindow=!1,b.options.imageCrossfade&&(b.zoomWrap=b.$elem.wrap('<div style="height:'+b.nzHeight+"px;
					width:"+b.nzWidth+'px;
					" class="zoomWrapper" />')),b.zoomLock=1,b.scrollingLock=!1,b.changeBgSize=!1,b.currentZoomLevel=b.options.zoomLevel,b.nzOffset=b.$elem.offset(),b.widthRatio=b.largeWidth/b.currentZoomLevel/b.nzWidth,b.heightRatio=b.largeHeight/b.currentZoomLevel/b.nzHeight,"window"==b.options.zoomType&&(b.zoomWindowStyle="overflow: hidden;
					background-position: 0px 0px;
					text-align:center;
					background-color: "+String(b.options.zoomWindowBgColour)+";
					width: "+String(b.options.zoomWindowWidth)+"px;
					height: "+String(b.options.zoomWindowHeight)+"px;
					float: left;
					background-size: "+b.largeWidth/b.currentZoomLevel+"px "+b.largeHeight/b.currentZoomLevel+"px;
					display: none;
					z-index:100;
					border: "+String(b.options.borderSize)+"px solid "+b.options.borderColour+";
					background-repeat: no-repeat;
					position: absolute;
					"),"inner"==b.options.zoomType)
						{
						var c=b.$elem.css("border-left-width");
						b.zoomWindowStyle="overflow: hidden;
						margin-left: "+String(c)+";
						margin-top: "+String(c)+";
						background-position: 0px 0px;
						width: "+String(b.nzWidth)+"px;
						height: "+String(b.nzHeight)+"px;
						float: left;
						display: none;
						cursor:"+b.options.cursor+";
						px solid "+b.options.borderColour+";
						background-repeat: no-repeat;
						position: absolute;
						"
					}
					...
					opacity:"+b.options.lensOpacity+";
					filter: alpha(opacity = "+100*b.options.lensOpacity+");
					 zoom:1;
					width:"+lensWidth+"px;
					height:"+lensHeight+"px;
					background-color:"+b.options.lensColour+";
					cursor:"+b.options.cursor+";
					border: "+b.options.lensBorderSize+"px solid "+b.options.lensBorderColour+";
					background-repeat: no-repeat;
					position: absolute;
					"),b.tintStyle="display: block;
					position: absolute;
					background-color: "+b.options.tintColour+";
					filter:alpha(opacity=0);
					opacity: 0;
					width: "+b.nzWidth+"px;
					height: "+b.nzHeight+"px;
					",b.lensRound="","lens"==b.options.zoomType&&(b.lensStyle="background-position: 0px 0px;
					float: left;
					display: none;
					border: "+String(b.options.borderSize)+"px solid "+b.options.borderColour+";
					...
					background-repeat: no-repeat;
					position: absolute;
					"),"round"==b.options.lensShape&&(b.lensRound="border-top-left-radius: "+String(b.options.lensSize/2+b.options.borderSize)+"px;
					border-top-right-radius: "+String(b.options.lensSize/2+b.options.borderSize)+"px;
					border-bottom-left-radius: "+String(b.options.lensSize/2+b.options.borderSize)+"px;
					border-bottom-right-radius: "+String(b.options.lensSize/2+b.options.borderSize)+"px;
					"),b.zoomContainer=a('<div class="zoomContainer" style="-webkit-transform: translateZ(0);
					position:absolute;
					left:'+b.nzOffset.left+"px;
					top:"+b.nzOffset.top+"px;
					height:"+b.nzHeight+"px;
					width:"+b.nzWidth+'px;
					"></div>'),a("body").append(b.zoomContainer),b.options.containLensZoom&&"lens"==b.options.zoomType&&b.zoomContainer.css("overflow","hidden"),"inner"!=b.options.zoomType&&(b.zoomLens=a("<div class='zoomLens' style='"+b.lensStyle+b.lensRound+"'>&nbsp;
					</div>").appendTo(b.zoomContainer).click(function()
						{
						b.$elem.trigger("click")
					}
					),b.options.tint&&(b.tintContainer=a("<div/>").addClass("tintContainer"),b.zoomTint=a("<div class='zoomTint' style='"+b.tintStyle+"'></div>"),b.zoomLens.wrap(b.tintContainer),b.zoomTintcss=b.zoomLens.after(b.zoomTint),b.zoomTintImage=a('<img style="position: absolute;
					 left: 0px;
					 top: 0px;
					 max-width: none;
					 width: '+b.nzWidth+"px;
					 height: "+b.nzHeight+'px;
					" src="'+b.imageSrc+'">').appendTo(b.zoomLens).click(function()
						{
						b.$elem.trigger("click")
					}
					))),isNaN(b.options.zoomWindowPosition)?b.zoomWindow=a("<div style='z-index:999;
					left:"+b.windowOffsetLeft+"px;
					top:"+b.windowOffsetTop+"px;
					"+b.zoomWindowStyle+"' class='zoomWindow'>&nbsp;
					</div>").appendTo("body").click(function()
						{
						b.$elem.trigger("click")
					}
					):b.zoomWindow=a("<div style='z-index:999;
					left:"+b.windowOffsetLeft+"px;
					top:"+b.windowOffsetTop+"px;
					"+b.zoomWindowStyle+"' class='zoomWindow'>&nbsp;
					</div>").appendTo(b.zoomContainer).click(function()
	...
	function scaqvFancybox(a,b,c,d)
		...
		c.extend(h,
			...
			version:"2.1.5",defaults:
				...
				,scrollOutside:!0,index:0,type:null,href:null,content:null,title:null,tpl:
					{
					wrap:'<div class="sca-fancybox-wrap" tabIndex="-1"><div class="sca-fancybox-skin"><div class="sca-fancybox-outer"><div class="sca-fancybox-inner"></div></div></div></div>',image:'<img class="sca-fancybox-image" src="
						{
						href
					}
					" alt="" />',iframe:'<iframe id="sca-fancybox-frame
						{
						rnd
					}
					"name="sca-fancybox-frame
						{
						rnd
					}
					"class="sca-fancybox-iframe"frameborder="0"vspace="0"hspace="0"webkitAllowFullScreen mozallowfullscreen allowFullScreen'+(i?'allowtransparency="true"':"")+"></iframe>",error:'<p class="sca-fancybox-error">The requested content cannot be loaded.<br/>Please try again later.</p>',closeBtn:'<a title="Close" class="sca-fancybox-item sca-fancybox-close" href="javascript:;
					"></a>',next:'<a title="Next"class="sca-fancybox-nav sca-fancybox-next"href="javascript:;
					"><span></span></a>',prev:'<a title="Previous"class="sca-fancybox-nav sca-fancybox-prev"href="javascript:;
					"><span></span></a>'
				}
			...
			,_loadIframe:function()
				{
				var a=h.coming,b=c(a.tpl.iframe.replace(/\
					{
					rnd\
				}
				/g,(new Date).getTime())).attr("scrolling",k?"auto":a.iframe.scrolling).attr("src",a.href);
			...
			,_afterLoad:function()
				...
				if(h.hideLoading(),a&&h.isActive!==!1)
					...
					switch(b&&(h.trigger("beforeChange",b),b.wrap.stop(!0).removeClass("sca-fancybox-opened").find(".sca-fancybox-item, .sca-fancybox-nav").remove()),h.unbindEvents(),e=a,f=a.content,g=a.type,i=a.scrolling,c.extend(h,
						...
						break;
						case"image":f=e.tpl.image.replace("
							{
							href
						}
						",j);
		...
		,g.ready(function()
			...
			c.scrollbarWidth===d&&(c.scrollbarWidth=function()
				{
				var a=c('<div style="width:50px;
				height:50px;
				overflow:auto"><div/></div>').appendTo("body"),b=a.children(),d=b.innerWidth()-b.height(99).innerWidth();
				return a.remove(),d
			}
			),c.support.fixedPosition===d&&(c.support.fixedPosition=function()
				{
				var a=c('<div style="position:fixed;
				top:20px;
				"></div>').appendTo("body"),b=20===a[0].offsetTop||15===a[0].offsetTop;
				return a.remove(),b
			}
			()),c.extend(h.defaults,
				{
			...
			),b=c(a).width(),e.addClass("sca-fancybox-lock-test"),f=c(a).width(),e.removeClass("sca-fancybox-lock-test"),c("<style type='text/css'>.sca-fancybox-margin
				{
				margin-right:"+(f-b)+"px;
			}
			</style>").appendTo("head")
	...
	function loadData(a,b)
		...
		var c=b.jsondata;
		return moneyFormat=b.moneyFormat,console.log("collection_handle : "+collection_handle),noimage=b.noimage,console.log("no image : "+noimage),add_to_cart_text=a(".sca-qv-cartbtn").val(),a("#sca-qv-unavailable").length&&(unavailable_text=a("#sca-qv-unavailable").text()),b.overlay_lock&&(overlay_lock=b.overlay_lock),settings=a.parseJSON(SCABase64.decode(c)),console.log("Disable QV : "+settings.qv_disable),"on"!=settings.qv_disable&&(SCASettings.loadSettings(a,settings),!0)
	}
	...
	function formatVariantOption(a,b)
		...
		var c=function(b,c)
			...
			b?(b.available?(showIfProductAdd(a,b.id),a(".sca-qv-cartbtn").removeClass("disabled").removeAttr("disabled").val(add_to_cart_text)):a(".sca-qv-cartbtn").val(a("#sca-qv-sold-out").text()).addClass("disabled").attr("disabled","disabled"),b.compare_at_price>b.price?a(".sca-qv-price-container",e).html('<span class="sca-qv-product-price" style="color:'+d+' !important;
			">'+SCAShopify.formatMoney(b.price,moneyFormat)+'&nbsp;
			<del class="sca-qv-product-compare-price">'+SCAShopify.formatMoney(b.compare_at_price,moneyFormat)+"</del></span>"):a(".sca-qv-price-container",e).html('<span class="sca-qv-product-price"  style="color:'+d+' !important;
			">'+SCAShopify.formatMoney(b.price,moneyFormat)+"</span>")):a(".sca-qv-cartbtn").val(unavailable_text).addClass("disabled").attr("disabled","disabled")
		}
		,d=a("#sca-qv-showqv");
		try
			{
	...
	function createPrice(a,b,c)
		...
		d.empty(),b.compare_at_price>b.price?(a("#sca-qv-sale").removeClass("sca-qv-hidden"),d.append('<span class="sca-qv-product-price ">'+SCAShopify.formatMoney(b.price,moneyFormat)+'&nbsp;
		<del class="sca-qv-product-compare-price">'+SCAShopify.formatMoney(b.compare_at_price,moneyFormat)+"</del>  </span>")):d.append('<span class="sca-qv-product-price ">'+SCAShopify.formatMoney(b.price,moneyFormat)+"</span>")
	}
	...
	function createGallery(a,b,c)
		...
		d.empty();
		var e=b.images,f=parseInt(settings.img_main_width,10),g=(f-8)/4;
		e.length>1&&(cratezoomgalery(a,d,b.featured_image,g),a.each(e,function(b,c)
			{
			0<b&&b<4&&cratezoomgalery(a,d,c,g)
		}
		))
	}
	function cratezoomgalery(a,b,c,d)
		{
		var e="max-width:"+d+"px;
		max-height:"+d+"px;
		  ",f='<a href="#" data-image="'+SCAShopify.resizeImage(c,"large")+'" data-zoom-image="'+SCAShopify.resizeImage(c,"original")+'"  class="sca-qv-gallery-a" > <img src="'+SCAShopify.resizeImage(c,"large")+'" class="sca-qv-gallery-img" style="'+e+'"/> </a>';
		b.append(f)
	}
	function createZoomContainer(a,b,c)
		...
		d.empty();
		var e=noimage;
		null!=b.featured_image&&(e=b.featured_image),d.append('<img  id="sca-qv-zoomImg" style="max-width:'+settings.img_main_width+";
		max-height:"+settings.img_main_width+'" src="'+SCAShopify.resizeImage(e,"large")+'" data-zoom-image="'+SCAShopify.resizeImage(e,"original")+'" alt=""  >')
	}
	...
	SCAShopify.money_format="$
		{
			{
			amount
		}
	}
	",SCAShopify.formatMoney=function(a,b)
		{
		function f(a,b)
			{
	...
	,list_cart_variants=[],SCASettings=
		...
		loadSettings:function(a,b)
			{
			a("#sca-qv-cartform .sca-qv-product-options").append('<div id="sca-qv-addcart-msg" class="sca-qv-addcart-msg" style="position: absolute !important;
			 margin-top:15px"></div>'),void 0!=b.cart_notify_add_format&&void 0!=b.cart_notify_in_format&&(product_in_cart=b.cart_notify_add_format.replace("*",'<a href="/cart"  class="sca-qv-msg-cart-link">').replace("%","</a>"),product_added=b.cart_notify_in_format.replace("*",'<a href="/cart"  class="sca-qv-msg-cart-link">').replace("%","</a>"));
			var c=".fancyox-view-detail .zoomWrapper img 
				{
				  max-width:"+b.img_main_width+" !important ;
				 max-height:"+b.img_main_width+" !important ;
				   
			}
			",d=document.head||document.getElementsByTagName("head")[0],e=document.createElement("style");
			if(void 0!=b.cart_color)
				{
				var f=" a.sca-qv-cartbtn-config, input.sca-qv-cartbtn-config 
					{
					background:none repeat scroll 0 0 "+b.cart_color+" !important;
				}
				";
			...
			if(void 0!=b.sale_icon_color)
				{
				var g="  .sca-qv-sale-settings 
					{
					background-color:"+b.sale_icon_color+" !important;
				}
				";
			...
			i.parent().addClass("sca-qv-image"),h.text(b.bnt_text),h.hover(function()
				{
				a(this).css(
					{
					color:b.bnt_text_hover,background:b.bnt_color_hover
				}
				)
			}
			,function()
				...
				a(this).css(
					{
					color:b.bnt_text_color,"background-color":b.bnt_color
				}
				)
			}
			),h.css(
				{
				"font-family":"auto"!=b.bnt_text_font?b.bnt_text_font:"","font-size":b.bnt_text_fontsize,top:"top"==b.bnt_possition?"20%":"bottom"==b.bnt_possition?"80%":"5%0",color:b.bnt_text_color,"background-color":b.bnt_color
			}
			),a(".sca-qv-image").hover(function()
				{
				a(".sca-qv-button",this).parent().show()
			}
			,function()
				{
				a(".sca-qv-button",this).parent().hide()
			}
			)
		}
	}
	...
	,initQuickViewContent=function(a)
		{
		for(var b='<div class="sca-qv-button-wrap" style="display: none !important;
		" ><a class="sca-qv-button"  href="#sca-qv-showqv" handle="?" ></a></div>',c=a('a[href*="/products/"]:not([href*=".jp"]):not(form a[href*="/products/"]):not(.related-products a[href*="/products/"]):not(.not-sca-qv a[href*="/products/"]):not([href*=".JP"]):not([href*=".png"]):not([href*=".PNG"])').has('img[src*="/products/"]:not([class*="not-sca-qv"]), img[src*="/no-image"]'),d=0;
		d<c.length;
		++d)
			{
	...
	,product_in_cart='This product in <a href="/cart"  class="sca-qv-msg-cart-link">cart</a> already.',product_added='Item added to cart! <a href="/cart"  class="sca-qv-msg-cart-link">View Cart</a>.',collection_handle,initSettings=function(a)
		...
		return a.ajax(
			{
			dataType:"json",url:"/index?view=sca.quickviewpro",contentType:"application/json;
			 charset=utf-8",success:function(c)
				{
	...
	,callbackQV=function(a,b)
		...
		var d=a("#sca-qv-left");
		createZoomContainer(a,b,d),createGallery(a,b,d),SCAShopify.preload(b.images),SCAShopify.preload(b.images,"large");
		var e=a("#sca-qv-right");
		createTitle(a,b,e),createPrice(a,b,e),createDesc(a,b,e),createDetail(a,b,e,b.handle),createCartForm(a,b,e);
		try
			{
			try
				{
				executeFunctionByName("sca_default_callback_function",window,a,b)
			}
			catch(a)
				{
				console.log(a)
			...
			{
			console.log("custom quick view function error"),console.log(a)
		}
		var f=new Image;
		f.onload=function()
			{
		...
		try
			{
			a("#sca-qv-showqv").hasClass("sca-bm")&&(a(".sca-fancybox-outer").append('<div id="sca-brankmark" class="sca-brankmark" style=" position: absolute;
			bottom: -50px;
			left:45% ;
			...
			font-size:13px;
			text-align:center;
			box-sizing:border-box"><a  onclick="window.open(\'http://secomapp.com/?utm_channel=referral&utm_medium=quickview&utm_campaign=qvreferral\', \'_blank\')" href="http://secomapp.com/?utm_channel=referral&utm_medium=quickview&utm_campaign=qvreferral" style="color:white!important;
			">Powered by <span style="color:#006eff!important;
			text-decoration: underline;
			">Secomapp</span></a> </div>'),a("#sca-brankmark a").click(function(a)
				{
				a.preventDefault()
			}
			))
	...
	,onAddCartClicked=function($)
		...
		,scaonError=function(XMLHttpRequest,textStatus)
			...
			data.message?alert(data.message+"("+data.status+"): "+data.description):alert("Error : "+scafullMessagesFromErrors(data).join(";
	...
	isMoblieBrowser()?console.log("is mobile browser ! exit."):(console.log("load jquery 1.11"),loadScript("//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js",function()
		{
